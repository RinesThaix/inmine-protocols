 ...
 */
public class MWPacket5PluginSessionCreate extends Packet {

    public ServerType serverType;
    public int projectId;
    public UUID session;

    public MWPacket5PluginSessionCreate() { }

    public MWPacket5PluginSessionCreate(ServerType serverType, int projectId, UUID session) {
